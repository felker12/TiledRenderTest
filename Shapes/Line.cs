...
namespace TiledRenderTest.Shapes
{
    public class Line : IDisposable
    {
        ...
        // Pool size of 6 vertices for TriangleList (2 triangles)
        ...
        public void RebuildThickVertices(int thickness = 2)
        {
            ...
            Vector2 a1 = Position + offset;    // top-left
            Vector2 a2 = Position - offset;    // bottom-left  
            Vector2 b1 = Position2 + offset;   // top-right
            Vector2 b2 = Position2 - offset;   // bottom-right

            // Triangle 1: a1, a2, b1 (top-left, bottom-left, top-right)
            ...
            // Triangle 2: a2, b2, b1 (bottom-left, bottom-right, top-right)
            thickVertices[3] = new VertexPositionColor(new Vector3(a2, 0), Color);
            thickVertices[4] = new VertexPositionColor(new Vector3(b2, 0), Color);
            thickVertices[5] = new VertexPositionColor(new Vector3(b1, 0), Color);
